...
public class CrazyLambdas {
    ...
    public static Supplier<String> helloSupplier() {
        ...
        return supplier; //or can directly return () -> "Hello"
    }
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        BiFunction<String, Integer, String> function = (str, n) -> str.repeat(n);
        return function;
    }
    ...
    public static Function<BigDecimal, String> toDollarStringFunction() {
        Function<BigDecimal, String> bigDecimalStringFunction = (bigDecimal -> "$" + bigDecimal.toString());
        return bigDecimalStringFunction;
    }
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        return (bound) -> new Random(bound).nextInt();
    }
    ...
    public static Supplier<IntUnaryOperator> nMultiplyFunctionSupplier(int n) {
        IntUnaryOperator operator = (x) -> n * x;
        return () -> operator;
    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return fun -> fun.compose(s -> s.trim());
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (fun, predicate) ->
                x -> predicate.test(x) ? fun.applyAsInt(x) : x;
    }
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> function =
                (map, str) ->
                        map.containsKey(str) ? map.get(str) : IntUnaryOperator.identity();
        return function;
    }
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> comparing(Function<? super T, ? extends U> mapper) {
        return (x1, x2) -> {
            U u1 = mapper.apply(x1);
            U u2 = mapper.apply(x2);
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(
        ...
        return (x1, x2) -> comparator.compare(x1, x2) != 0 ? comparator.compare(x1, x2) : comparing(mapper).compare(x1, x2);
    }
